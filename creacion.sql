...
BEGIN
	...
	BEGIN
		...
		SET @ID_CLIENTE_OUT = CONVERT (INT,(SELECT CURRENT_VALUE FROM SYS.SEQUENCES WHERE [NAME]='PERSONA_SEQ'));
	END
END
GO
...
BEGIN
	...
	BEGIN
		...
		SET @ID_EMPRESA_OUT = CONVERT (INT,(SELECT CURRENT_VALUE FROM SYS.SEQUENCES WHERE [NAME]='EMPRESA_SEQ'));
	END
END
GO
