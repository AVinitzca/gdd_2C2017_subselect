...
DROP PROCEDURE SUBSELECT.SP_ABM_ITEMS_FACTURA_MODIFICAR;
DROP PROCEDURE SUBSELECT.SP_ABM_ITEMS_FACTURA_ELIMINAR;
...
DROP PROCEDURE SUBSELECT.GET_RENDICIONES;
DROP PROCEDURE SUBSELECT.DEVOLUCION_FACTURAS_PAGADAS;
DROP PROCEDURE SUBSELECT.DEVOLUCION_RENDICION;
DROP PROCEDURE SUBSELECT.GET_FACTURA_POR_EMPRESA;
DROP PROCEDURE SUBSELECT.GET_FACTURAS_NO_PAGA;
DROP PROCEDURE SUBSELECT.BORRAR_FACTURAS;
...
DROP FUNCTION SUBSELECT.REMAIL;
